// Sky Manga v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/skymanga/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => SkymangaSource
});
...
// plugins/skymanga/index.ts
var SkymangaSource = class extends MangaThemesiaSource {
  constructor() {
    super({
