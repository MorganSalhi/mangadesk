// DragonTea v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/dragontea/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => DragonteaSource
});
...
// plugins/dragontea/index.ts
var DragonteaSource = class extends MadaraSource {
  constructor() {
    super({
