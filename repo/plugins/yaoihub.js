// Yaoihub v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/yaoihub/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => YaoihubSource
});
...
// plugins/yaoihub/index.ts
var YaoihubSource = class extends MadaraSource {
  constructor() {
    super({
