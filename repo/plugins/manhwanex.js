// ManhwaNex v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/manhwanex/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ManhwanexSource
});
...
// plugins/manhwanex/index.ts
var ManhwanexSource = class extends MadaraSource {
  constructor() {
    super({
