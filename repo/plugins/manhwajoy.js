// Manhwajoy v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/manhwajoy/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ManhwajoySource
});
...
// plugins/manhwajoy/index.ts
var ManhwajoySource = class extends MadaraSource {
  constructor() {
    super({
