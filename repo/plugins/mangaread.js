// Manga Read v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/mangaread/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => MangareadSource
});
...
// plugins/mangaread/index.ts
var MangareadSource = class extends MadaraSource {
  constructor() {
    super({
