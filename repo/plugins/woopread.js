// WoopRead v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/woopread/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => WoopreadSource
});
...
// plugins/woopread/index.ts
var WoopreadSource = class extends MadaraSource {
  constructor() {
    super({
