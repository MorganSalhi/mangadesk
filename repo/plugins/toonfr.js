// Toon FR v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/toonfr/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ToonFrSource
});
...
// plugins/toonfr/index.ts
var ToonFrSource = class extends MadaraSource {
  constructor() {
    super({
