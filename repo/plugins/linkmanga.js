// LinkManga v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/linkmanga/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => LinkmangaSource
});
...
// plugins/linkmanga/index.ts
var LinkmangaSource = class extends MadaraSource {
  constructor() {
    super({
