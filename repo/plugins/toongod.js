// ToonGod v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/toongod/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ToongodSource
});
...
// plugins/toongod/index.ts
var ToongodSource = class extends MadaraSource {
  constructor() {
    super({
