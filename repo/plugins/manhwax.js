// Manhwax v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/manhwax/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ManhwaxSource
});
...
// plugins/manhwax/index.ts
var ManhwaxSource = class extends MangaThemesiaSource {
  constructor() {
    super({
