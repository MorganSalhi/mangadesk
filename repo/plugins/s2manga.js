// S2Manga v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/s2manga/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => S2mangaSource
});
...
// plugins/s2manga/index.ts
var S2mangaSource = class extends MadaraSource {
  constructor() {
    super({
