// AP Comics v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/apcomics/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ApcomicsSource
});
...
// plugins/apcomics/index.ts
var ApcomicsSource = class extends MadaraSource {
  constructor() {
    super({
