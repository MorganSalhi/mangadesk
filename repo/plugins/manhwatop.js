// Manhwatop v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/manhwatop/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ManhwatopSource
});
...
// plugins/manhwatop/index.ts
var ManhwatopSource = class extends MadaraSource {
  constructor() {
    super({
