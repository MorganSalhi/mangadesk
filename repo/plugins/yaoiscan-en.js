// YaoiScan (EN) v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/yaoiscan-en/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => YaoiscanEnSource
});
...
// plugins/yaoiscan-en/plugin.json
var plugin_default = {
  id: "yaoiscan-en",
  name: "YaoiScan (EN)",
  lang: "en",
...
// plugins/yaoiscan-en/index.ts
var YaoiscanEnSource = class extends MadaraSource {
  constructor() {
    super({
