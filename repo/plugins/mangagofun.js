// MangaGo.fun v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/mangagofun/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => MangagofunSource
});
...
// plugins/mangagofun/plugin.json
var plugin_default = {
  id: "mangagofun",
  name: "MangaGo.fun",
  lang: "en",
...
// plugins/mangagofun/index.ts
var MangagofunSource = class extends MadaraSource {
  constructor() {
    super({
