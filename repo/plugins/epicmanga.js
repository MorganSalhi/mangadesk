// EpicManga v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/epicmanga/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => EpicmangaSource
});
...
// plugins/epicmanga/index.ts
var EpicmangaSource = class extends MadaraSource {
  constructor() {
    super({
