// Arya Scans v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/aryascans/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => AryascansSource
});
...
// plugins/aryascans/index.ts
var AryascansSource = class extends MadaraSource {
  constructor() {
    super({
