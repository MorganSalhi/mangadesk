// ManhuaUS v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/manhuaus/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => ManhuausSource
});
...
// plugins/manhuaus/index.ts
var ManhuausSource = class extends MadaraSource {
  constructor() {
    super({
