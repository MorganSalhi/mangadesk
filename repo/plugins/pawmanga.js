// Paw Manga v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/pawmanga/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => PawmangaSource
});
...
// plugins/pawmanga/index.ts
var PawmangaSource = class extends MadaraSource {
  constructor() {
    super({
