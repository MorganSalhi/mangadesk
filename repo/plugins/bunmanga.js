// Bun Manga v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/bunmanga/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => BunmangaSource
});
...
// plugins/bunmanga/index.ts
var BunmangaSource = class extends MadaraSource {
  constructor() {
    super({
