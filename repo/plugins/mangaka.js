// MangaKa v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/mangaka/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => MangakaSource
});
...
// plugins/mangaka/index.ts
var MangakaSource = class extends MadaraSource {
  constructor() {
    super({
