// Rackus v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/pmscans/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => PmscansSource
});
...
// plugins/pmscans/index.ts
var PmscansSource = class extends MangaThemesiaSource {
  constructor() {
    super({
