// YaoiScan v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/yaoiscan/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => YaoiScanSource
});
...
// plugins/yaoiscan/index.ts
var YaoiScanSource = class extends MangaThemesiaSource {
  constructor() {
    super({
