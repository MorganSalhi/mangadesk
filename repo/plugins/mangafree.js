// Mangafree v1.0.0 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/mangafree/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => MangafreeSource
});
...
// plugins/mangafree/index.ts
var MangafreeSource = class extends MadaraSource {
  constructor() {
    super({
