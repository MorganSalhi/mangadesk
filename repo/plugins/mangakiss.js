// Manga Kiss v1.0.1 — plugin MangaDesk (généré par scripts/build-plugins.mjs, ne pas éditer)
"use strict";
...
// plugins/mangakiss/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => MangakissSource
});
...
// plugins/mangakiss/index.ts
var MangakissSource = class extends MadaraSource {
  constructor() {
    super({
